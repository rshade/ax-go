...
// combinations × 6 GOOS/GOARCH profiles = 24 loads of the eight public
// packages.
//
...
// requested package within it. Adding an eighth public package (axtest)
// therefore left this at 24.
//
